<html lang="{PHP_CurrentLangISOCode}">
    ...
    <body>
        ...
        <form action="" method="post" onsubmit="return confirm('{Form_Confirm}');">
                ...
                <table style="width: 800px;">
                    ...
                    <tbody style="{PHP_HideFormBox}">
                        ...
                        <tr>
                            ...
                            <th><input type="text" name="set_admin_username" value="{set_admin_username}" {PHP_BadVal_set_admin_username} tabindex="12"/></th>
                            <th>{Tip_Admin_Username}</th>
                        </tr>
                        <tr>
                            <th>{Label_Admin_Password} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_admin_password" value="{set_admin_password}" {PHP_BadVal_set_admin_password} tabindex="13"/></th>
                            <th>{Tip_Admin_Password}</th>
                        </tr>
                        <tr>
                            <th>{Label_Admin_Email} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_admin_email" value="{set_admin_email}" {PHP_BadVal_set_admin_email} tabindex="14"/></th>
                        ...
                        <tr>
                            ...
                            <th><input type="text" name="set_uni_gamespeed" value="{set_uni_gamespeed}" {PHP_BadVal_set_uni_gamespeed} tabindex="16"/></th>
                            <th>{Tip_Uni_GameSpeed}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_FleetSpeed} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_fleetspeed" value="{set_uni_fleetspeed}" {PHP_BadVal_set_uni_fleetspeed} tabindex="17"/></th>
                            <th>{Tip_Uni_FleetSpeed}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_ResourceSpeed} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_resourcespeed" value="{set_uni_resourcespeed}" {PHP_BadVal_set_uni_resourcespeed} tabindex="18"/></th>
                            <th>{Tip_Uni_ResourceSpeed}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_MotherFields} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_motherfields" value="{set_uni_motherfields}" {PHP_BadVal_set_uni_motherfields} tabindex="19"/></th>
                            <th>{Tip_Uni_MotherFields}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_FleetDebris} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_fleetdebris" value="{set_uni_fleetdebris}" {PHP_BadVal_set_uni_fleetdebris} tabindex="20"/></th>
                            <th>{Tip_Uni_FleetDebris}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_DefenseDebris} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_defensedebris" value="{set_uni_defensedebris}" {PHP_BadVal_set_uni_defensedebris} tabindex="21"/></th>
                            <th>{Tip_Uni_DefenseDebris}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_MissileDebris} <b style="color: orange">(*)</b></th>
                            <th><input type="text" name="set_uni_missiledebris" value="{set_uni_missiledebris}" {PHP_BadVal_set_uni_missiledebris} tabindex="22"/></th>
                            <th>{Tip_Uni_MissileDebris}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_MailActivationNeeded}</th>
                            <th><input type="checkbox" name="set_uni_mailactivationneeded" {set_uni_mailactivationneeded} tabindex="23"/></th>
                            <th>{Tip_Uni_MailActivationNeeded}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_TelemetryEnable}</th>
                            <th><input type="checkbox" name="set_uni_telemetryenable" {set_uni_telemetryenable} tabindex="24"/></th>
                            <th>{Tip_Uni_TelemetryEnable}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AutoToolPass_StatBuilder}</th>
                            <th><input type="text" name="set_uni_autotoolpass_statbuilder" value="{set_uni_autotoolpass_statbuilder}" tabindex="25"/></th>
                            <th>{Tip_Uni_AutoToolPass_StatBuilder}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AutoToolPass_GarbageCollector}</th>
                            <th><input type="text" name="set_uni_autotoolpass_gc" value="{set_uni_autotoolpass_gc}" tabindex="26"/></th>
                            <th>{Tip_Uni_AutoToolPass_GarbageCollector}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AutoToolPass_GZipLog}</th>
                            <th><input type="text" name="set_uni_autotoolpass_gziplog" value="{set_uni_autotoolpass_gziplog}" tabindex="27"/></th>
                        ...
                        <tr>
                            ...
                            <th><input type="checkbox" name="set_uni_noobprt_enable" {set_uni_noobprt_enable} tabindex="28"/></th>
                        ...
                        <tr>
                            ...
                            <th><input type="text" name="set_uni_noobprt_basicmultiplier" value="{set_uni_noobprt_basicmultiplier}" {PHP_BadVal_set_uni_noobprt_basicmultiplier} tabindex="30"/></th>
                            <th>{Tip_Uni_NoobProtectionBasicLimitMultiplier}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_NoobProtectionRemove}</th>
                            <th><input type="text" name="set_uni_noobprt_remove" value="{set_uni_noobprt_remove}" {PHP_BadVal_set_uni_noobprt_remove} tabindex="31"/></th>
                            <th>{Tip_Uni_NoobProtectionRemove}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_NoobProtectionIdleDays}</th>
                            <th><input type="text" name="set_uni_noobprt_idledays" value="{set_uni_noobprt_idledays}" {PHP_BadVal_set_uni_noobprt_idledays} tabindex="32"/></th>
                            <th>{Tip_Uni_NoobProtectionIdleDays}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_NoobProtectionFirstLogin}</th>
                            <th><input type="text" name="set_uni_noobprt_firstlogin" value="{set_uni_noobprt_firstlogin}" {PHP_BadVal_set_uni_noobprt_firstlogin} tabindex="33"/></th>
                        ...
                        <tr>
                            ...
                            <th><input type="checkbox" name="set_uni_antifarmenable" {set_uni_antifarmenable} tabindex="34"/></th>
                            <th>{Tip_Uni_AntiFarm_Enabled}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiFarm_Ratio}</th>
                            <th><input type="text" name="set_uni_antifarmratio" value="{set_uni_antifarmratio}" {PHP_BadVal_set_uni_antifarmratio} tabindex="35"/></th>
                            <th>{Tip_Uni_AntiFarm_Ratio}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiFarm_TotalCount}</th>
                            <th><input type="text" name="set_uni_antifarmtotalcount" value="{set_uni_antifarmtotalcount}" {PHP_BadVal_set_uni_antifarmtotalcount} tabindex="36"/></th>
                            <th>{Tip_Uni_AntiFarm_TotalCount}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiFarm_PlanetCount}</th>
                            <th><input type="text" name="set_uni_antifarmplanetcount" value="{set_uni_antifarmplanetcount}" {PHP_BadVal_set_uni_antifarmplanetcount} tabindex="37"/></th>
                            <th>{Tip_Uni_AntiFarm_PlanetCount}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiBash_Enabled}</th>
                            <th><input type="checkbox" name="set_uni_antibashenable" {set_uni_antibashenable} tabindex="38"/></th>
                            <th>{Tip_Uni_AntiBash_Enabled}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiBash_Interval}</th>
                            <th><input type="text" name="set_uni_antibashinterval" value="{set_uni_antibashinterval}" {PHP_BadVal_set_uni_antibashinterval} tabindex="39"/></th>
                            <th>{Tip_Uni_AntiBash_Interval}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiBash_TotalCount}</th>
                            <th><input type="text" name="set_uni_antibashtotalcount" value="{set_uni_antibashtotalcount}" {PHP_BadVal_set_uni_antibashtotalcount} tabindex="40"/></th>
                            <th>{Tip_Uni_AntiBash_TotalCount}</th>
                        </tr>
                        <tr>
                            <th>{Label_Uni_AntiBash_PlanetCount}</th>
                            <th><input type="text" name="set_uni_antibashplanetcount" value="{set_uni_antibashplanetcount}" {PHP_BadVal_set_uni_antibashplanetcount} tabindex="41"/></th>
                            <th>{Tip_Uni_AntiBash_PlanetCount}</th>
                        </tr>

                        <tr>
                            <td class="c" colspan="3"><input tabindex="42" type="submit" value="{Button_Install}" style="width: 90%; font-weight: bold; padding: 3px !important; color: lime;"/></td>
                        </tr>
                    </tbody>
                </table>
            </center>
