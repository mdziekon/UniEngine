...
<script src="dist/js/trader.cachebuster-1649641107436.min.js" type="text/javascript"></script>
...
<form action="merchant.php?step=2" method="post">
    ...
    <table style="width: 750px;">
        ...
        <tr>
            ...
            <th class="w120x">&nbsp;</th>
            <th><input name="cry" id="MainRes" type="text" value="0" tabindex="1" class="resInput" autocomplete="off"/></th>
        ...
        <tr>
            ...
            <th class="w120x">
                <div class="posRel">
                    <input type="button" class="modif" value="-"/>
                    <input class="percent" type="text" name="deuPercent" maxlength="3" value="50" autocomplete="off"/>
                    <input type="button" class="modif" value="+"/>
                    <span class="percent">%</span>
                </div>
            </th>
