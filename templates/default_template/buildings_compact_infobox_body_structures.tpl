<tbody id="nfoEl_{ElementID}" class="hide">
    <tr>
        ...
        <td class="center infoAction">
            <a class="{BuildButtonColor} infoButton {HideBuildButton}" href="?cmd=insert&amp;building={ElementID}"><span class="infoButtonText">{InfoBox_Build} {BuildLevel}</span></a>
            <a id="bDest_{ElementID}" class="{DestroyButtonColor} infoButton destButton {HideDestroyButton}" href="?cmd=destroy&amp;building={ElementID}"><span class="infoButtonText">{InfoBox_Destroy} {DestroyLevel}</span></a>
        </td>
    </tr>
