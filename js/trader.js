...
{    
    ...
    function Calculate(UsingMain){
        ...
        if(UsingMain === false){
            if(Mode == 1){
                var Needed = Math.ceil((ResA * Mod_ResA) + (ResB * Mod_ResB));
            } else if(Mode == 2){
                var Needed = Math.floor((ResA * Mod_ResA) + (ResB * Mod_ResB));
            }
    ...
    $('input.percent').change(function()
    {
        if($(this).attr('name') == NameResA+'Percent'){
            var OpositeSelector = $('[name="'+NameResB+'Percent"]');
        } else {
            var OpositeSelector = $('[name="'+NameResA+'Percent"]');
        }
