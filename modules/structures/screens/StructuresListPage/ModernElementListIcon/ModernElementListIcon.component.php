...
namespace UniEngine\Engine\Modules\Structures\Screens\StructuresListPage\ModernElementListIcon;
...
function render ($props) {
    ...
    $tplBodyCache = [
        'list_element' => gettemplate('buildings_compact_list_element_structures'),
