...
namespace UniEngine\Engine\Modules\Structures\Screens\StructuresListPage\LegacyElementListItem;
...
function render ($props) {
    ...
    $tplBodyCache = [
        'list_element_body' => gettemplate('buildings_legacy_list_element_structures'),
    ...
    $elementUpgradeProductionChangeComponentHTML = '';

    if ($isProductionRelatedStructure && $isUpgradeable) {
        $resourceLabels = [
            'metal'         => $_Lang['Metal'],
            'crystal'       => $_Lang['Crystal'],
            'deuterium'     => $_Lang['Deuterium'],
        ...
        foreach ($nextLevelProduction as $resourceKey => $nextLevelResourceProduction) {
            ...
            $resourceProductionChangeTPLData = [
                ...
                'ResourceStateColorClass'   => $resourceProductionChangeColor,
            ...
            $elementUpgradeProductionChangeComponentHTML .= parsetemplate(
                $tplBodyCache['list_element_productionchange_element'],
                $resourceProductionChangeTPLData
            );
        }
    }
    ...
    $componentTPLData = [
        ...
        'Component_UpgradeProductionChangeList' => $elementUpgradeProductionChangeComponentHTML,
